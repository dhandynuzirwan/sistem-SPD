                                            ...
                                            @foreach($reports as $report)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('reports.edit', $report->id) }}" class="btn btn-primary mb-1 mr-1">
                                                            <i class="la la-edit"></i>
                                                        </a>
                                                        <form action="{{ route('reports.destroy', $report->id) }}" method="POST" style="display: inline;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn btn-danger mb-1" onclick="return confirm('Are you sure you want to delete this report?')">
