                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Form Tambah Anggaran</div>
                                </div>
                                <div class="card-body">
                                    @if ($errors->any())
                                    ...
                                    <form action="{{ route('budgets.store') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="id_budget" class="form-control" id="id_budget" placeholder="Masukan Nomor Anggaran" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="detail">Uraian</label>
                                            <textarea name="detail" class="form-control" id="detail" rows="3" placeholder="Masukan Uraian"></textarea>
                                        </div>
                                        <div class="form-group d-flex" style="gap: 15px;">
                                            <div style="flex: 1;">
                                                <label for="volume">Volume</label>
                                                <input type="number" name="volume" class="form-control" id="volume" placeholder="Masukan Volume">
                                            </div>
                                            <div style="flex: 1;">
                                                <label for="unit">Satuan</label>
                                                <input type="text" name="unit" class="form-control" id="unit" placeholder="Masukan Satuan">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="amount">Harga Satuan</label>
                                            <input type="number" name="amount" class="form-control" id="amount" placeholder="Masukan Harga Satuan">
                                        </div>
                                        <div class="form-group">
